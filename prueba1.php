<html lang="es"><head>
    ...
    <script src="https://apis.google.com/_/scs/apps-static/_/js/k=oz.gapi.es.xx0fQiicufY.O/m=auth/exm=follow/rt=j/sv=1/d=1/ed=1/am=AQ/rs=AGLTcCOcR_dy8VcjEKdBF8UuZPAb3IRvJA/t=zcms/cb=gapi.loaded_1" async=""></script><script src="https://apis.google.com/_/scs/apps-static/_/js/k=oz.gapi.es.xx0fQiicufY.O/m=follow/rt=j/sv=1/d=1/ed=1/am=AQ/rs=AGLTcCOcR_dy8VcjEKdBF8UuZPAb3IRvJA/t=zcms/cb=gapi.loaded_0" async=""></script><script async="" src="//www.google-analytics.com/analytics.js"></script><script id="twitter-wjs" src="http://platform.twitter.com/widgets.js"></script><script>
      window.liveSettings = {
...
.txlive-dynamic {animation: txlivenodeinserted 0.001s; -webkit-animation: txlivenodeinserted 0.001s;}</style>
  ...
  <div class="row">
    ...
    <div class="col s12 m9 l10">
      ...
      <div id="color-usage" class="section scrollspy">
        <h2 class="header">Uso</h2>
        <p class="caption">Aquí tenemos una paleta de colores basados en los colores base de material design. Cada uno de estos colores está definido por una clase base de color y una clase opcional para aclararlo u oscurecerlo. </p>
        <div class="row section">
          <h5 class="col s12 m3">Color de Fondo</h5>
          <div class="col s12 m9">
            <p>Para aplicar un color de fondo, sólo añada el nombre del color y una clase para aclarar/oscurecer al elemento.</p>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation">=</span><span class="token punctuation">"</span>card-panel teal lighten-2<span class="token punctuation">"</span></span><span class="token punctuation">&gt;</span></span>This is a card panel with a teal lighten-2 class<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
          ...
          <h5 class="col s12 m3">Color de Texto</h5>
          <div class="col s12 m9">
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span>
      ...
      <div id="sass" class="section scrollspy">
        ...
        <p>Para los colores de fondo, puede aplicar el color simplemente extendiendo las clases como en el siguiente ejemplo. </p>
  ...
  <span class="token punctuation">}</span>
        ...
        <p>Para cambiar el color de texto, puede aplicar el color simplemente extendiendo las clases como en el siguiente ejemplo. </p>
        <pre class=" language-scss"><code class=" col s12 language-scss"><span class="token selector">
  .ilike-blue-container </span><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
      ...
      <div id="palette" class="section scrollspy">
        ...
        <h2 class="header">Paleta de Colores</h2>
    ...
    <div class="col hide-on-small-only m3 l2">
      <div class="toc-wrapper pin-top" style="top: 0px;">
        <div class="buysellads hide-on-small-only">
          <!-- CarbonAds Zone Code -->
          <script async="" type="text/javascript" src="//cdn.carbonads.com/carbon.js?zoneid=1673&amp;serve=C6AILKT&amp;placement=materializecss" id="_carbonads_js"></script><div id="carbonads"><span><span class="carbon-wrap"><a href="//srv.carbonads.net/ads/click/x/GTND423WFTSD5KJEFTS4YKQWCEADKKJNCKYIVZ3JCEBDE27LCVYIT5QKC6BDV53NCA7DVK3EHJNCLSIZ?segment=placement:materializecss;" class="carbon-img" target="_blank"><img src="//assets.servedby-buysellads.com/p/manage/asset/id/26184" alt="" border="0" height="100" width="130" style="max-width:130px;"></a><a href="//srv.carbonads.net/ads/click/x/GTND423WFTSD5KJEFTS4YKQWCEADKKJNCKYIVZ3JCEBDE27LCVYIT5QKC6BDV53NCA7DVK3EHJNCLSIZ?segment=placement:materializecss;" class="carbon-text" target="_blank">The easiest way to stay secure and private online. Black Friday Special 80% off.</a></span><a href="http://carbonads.net/" class="carbon-poweredby" target="_blank">ads via Carbon</a></span></div>
        </div>
        <div style="height: 1px;">
          <ul class="section table-of-contents">
            <li><a href="#color-usage" class="active">Uso</a></li>
            <li><a href="#sass">Sass</a></li>
            <li><a href="#palette">Paleta de Colores</a></li>
          </ul>
        </div>
      </div>
    </div>
...
<div id="tx-live-lang-container" class="txlive-langselector txlive-langselector-bottomright"><ul id="tx-live-lang-picker" class="txlive-langselector-list notranslate"><li data-value="en">English</li><li data-value="cs">Čeština</li><li data-value="nl">Nederlands</li><li data-value="fr">Français</li><li data-value="de">Deutsch</li><li data-value="ko">한국어</li><li data-value="pt">Português</li><li data-value="ru">Русский</li><li data-value="es">Español</li><li data-value="sv">Svenska</li></ul><div class="txlive-langselector-toggle notranslate" id="tx-live-lang-toggle"><span class="txlive-langselector-current" id="tx-live-lang-current">Español</span><span class="txlive-langselector-marker"></span></div></div><div class="hiddendiv common"></div><iframe name="oauth2relay851690370" id="oauth2relay851690370" src="https://accounts.google.com/o/oauth2/postmessageRelay?parent=http%3A%2F%2Fmaterializecss.com#rpctoken=421752726&amp;forcesecure=1" tabindex="-1" style="width: 1px; height: 1px; position: absolute; top: -100px;"></iframe><div class="drag-target" style="touch-action: pan-y; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); left: 0px;"></div></body></html>